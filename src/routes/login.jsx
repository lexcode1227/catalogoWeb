    ...
    return (
        <section className="bg-gray-50">
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input type="text" name="username" id="username" onChange={handleInputChange} value={formValues.username} className="bg-gray-50 border border-gray-300 text-gray-900 text-title rounded-lg block w-full p-2.5 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500" placeholder="admin123" required/>
                            </div>
                            <div>
                                <label htmlFor="password" className="block mb-2 text-title font-medium text-gray-900">Contraseña</label>
                                <input type="password" name="password" id="password" placeholder="••••••••" onChange={handleInputChange} value={formValues.password} className="bg-gray-50 border border-gray-300 text-gray-900 text-title rounded-lg block w-full p-2.5 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500" required/>
                            </div>
                            <div className="flex items-center justify-between">
                                ...
                                <button type="button" className="text-title font-medium text-blue-600 hover:underline" onClick={() => setOpenModal(true)}>¿Olvidaste tu contraseña?</button>
                            </div>
                            <button type="submit" className="w-full text-white bg-[#2563eb] hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-500 font-medium rounded-lg text-title px-5 py-2.5 text-center">Ingresar</button>
                ...
                <Modal show={openModal} onClose={() => setOpenModal(false)} className="h-auto">
                    <Modal.Header>Recuperar contraseña</Modal.Header>
                    <Modal.Body>
                        <div className="p-4 md:p-5 space-y-4">
                            <form className="flex flex-col gap-4" action="#" onSubmit={handleRecoverPass}>
                                <div>
                                    <label htmlFor="emailReset" className="block mb-2 text-title font-medium text-gray-900">Tu email</label>
