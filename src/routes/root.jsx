            ...
            <header className='flex justify-center items-center'>              
              <Navbar className='py-5 w-full max-w-[710px]' fluid rounded>
                ...
                <Navbar.Brand as={"button"}>
                  <Link to={"/"}><img src="/Logo.svg" className="mr-3 w-36 h-14" alt="Logo" /></Link>
                </Navbar.Brand>
                <nav className="flex justify-between items-center gap-5 md:order-2">
                      <Link to={"/discover"} className="text-base rounded-[20px] text-titleActive focus:ring-4 font-medium"><img src="/Search.svg" alt="logo" className="size-6"/></Link>
                      <Link to={"/cart"} className="text-base rounded-[20px] text-titleActive focus:ring-4 font-medium"><img src="/ShoppingBag.svg" alt="logo" className="size-6"/></Link>
                </nav>
                <Navbar.Collapse>
